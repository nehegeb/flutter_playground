...
# How to set up new pages for a module

0. In app/app_router/app_router.dart add the new module page.
0. In app/module_bar/widgets/module_bar_navigation.dart add the new module page.
