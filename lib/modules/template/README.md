...
6. TODO: AppRouter...
7. TODO: modules.json...
8. In at least `lib/app/localization/data/localization_english.json`...
...
9. Run the `flutter pub get` command in the terminal.
10. Start the app to make sure everything works.
