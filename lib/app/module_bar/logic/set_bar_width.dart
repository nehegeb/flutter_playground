...
/// Sets the width of the [ModuleBar] and saves it to [LocalCache].
...
void setBarWidth({required String width}) {
  ...
  // Set the [ModuleBar] width and save it to [LocalCache].
  switch (width) {
    case 'wide':
      ...
      // Save the width setting to [LocalCache].
    ...
    case 'narrow':
      ...
      // Save the narrow setting to [LocalCache].
