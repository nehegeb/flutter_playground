...
import 'package:flutter_playground/app/changelog/ui_widgets/version_expansion_tile.dart';
...
class ChangelogExpansionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, dynamic>? changelogData = Changelog.getChangelogData();
