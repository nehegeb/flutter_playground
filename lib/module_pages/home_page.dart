...
class HomePage extends StatelessWidget {
  ...
  static String get welcomeMessage {
    ...
    if (user == null || userName.isEmpty) {
      return '${Localization.getText('homePage.messageWelcome')}!';
    }
    ...
    final pascalName = userName
        ...
        .join('');
    return '${Localization.getText('homePage.messageWelcome')} $pascalName!';
  }
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: TextButton(
                          ...
                          child: Text(
                            Localization.getText('homePage.messageLogin'),
