...
import 'package:flutter_playground/notifiers/is_mobile_device_notifier/logic/set_is_mobile.dart';
import 'package:flutter_playground/notifiers/is_mobile_device_notifier/logic/set_by_context.dart';
...
class IsMobileDeviceNotifier {
  /// Get the current device type from the notifier.
  ...
  ///
  /// Note: This method is used to update the device type for the notifier directly.
  /// To reliably detect the actually used device type, use the [checkAndSet] method.
  static void setMobile(bool isMobile) {
    setIsMobile(isMobile);
  }

  /// Check if the device type (detected by screen size) has changed and update the notifier.
